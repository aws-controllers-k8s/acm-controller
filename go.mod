module github.com/aws-controllers-k8s/acm-controller
...
replace github.com/aws-controllers-k8s/runtime => /Users/alexwzx/go/src/github.com/aws-controllers-k8s/runtime
