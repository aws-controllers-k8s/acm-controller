...
{{- define "ack-acm-controller.app.name" -}}
...
*/}}
{{- define "ack-acm-controller.app.fullname" -}}
...
{{- define "ack-acm-controller.chart.name-version" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/* The name of the service account to use */}}
{{- define "ack-acm-controller.service-account.name" -}}
    {{ default "default" .Values.serviceAccount.name }}
{{- end -}}

{{- define "ack-acm-controller.watch-namespace" -}}
...
{{- define "ack-acm-controller.aws.credentials.secret_mount_path" -}}
{{- "/var/run/secrets/aws" -}}
{{- end -}}

{{/* The path the shared credentials file is mounted */}}
{{- define "ack-acm-controller.aws.credentials.path" -}}
{{ $secret_mount_path := include "ack-acm-controller.aws.credentials.secret_mount_path" . }}
{{- printf "%s/%s" $secret_mount_path .Values.aws.credentials.secretKey -}}
{{- end -}}

{{/* The rules a of ClusterRole or Role */}}
{{- define "ack-acm-controller.rbac-rules" -}}
rules:
- apiGroups:
  - ""
  resources:
...
{{- define "ack-acm-controller.feature-gates" -}}
{{- $list := list -}}
