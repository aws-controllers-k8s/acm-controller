...
const (
	finalizerString = "finalizers.acm.services.k8s.aws/Certificate"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("certificates")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.Certificate{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.Certificate),
	}
}
